#include "stdafx.h"
// FxRandomShoot.cpp: implementation of the CFxRandomShoot class.
//
//////////////////////////////////////////////////////////////////////
...
void CFxRandomShoot::LoadRes(IndexedTexture *pIndexedTexture)
{}

void CFxRandomShoot::DeleteRes()
{}

void CFxRandomShoot::Render(EffectSort &effect_sort)
{
	if( !GET_D3DDEVICE() )
		return;
	...
	// nate 2004 - 7 - image
	lpSurface = g_pCapsyongTexture->GetSurfaceByIdx( g_EffectTextr[ EFF_FX_RANDOMFIRE ] );
