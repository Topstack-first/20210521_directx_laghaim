#include "stdafx.h"
// FxTornadoHammer.cpp: implementation of the CFxBossRaidAidia3_01 class.
//
//////////////////////////////////////////////////////////////////////
...
#include "NkMob.h"
#include "FX_BossRaid_Aidia3_01.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CFxBossRaidAidia3_01::CFxBossRaidAidia3_01()
{
	m_pLolo = NULL;
}
...
void CFxBossRaidAidia3_01::LoadRes()
{
	if (!m_pLolo)
	{
		m_pLolo = new CLolos;
		m_pLolo->SetIndexedTexture( g_pCapsyongTexture );
		m_pLolo->Read("data/effect/lolos/eff_adia03_attack01.LOL");
	}
...
void CFxBossRaidAidia3_01::DeleteRes()
{}

BOOL CFxBossRaidAidia3_01::Render(EffectSort &effect_sort)
{
	if( !GET_D3DDEVICE() )
		return TRUE;
	...
	if( effect_sort.nCurFrame > FX_BOSSRAID_AIDIA3_01_FRAMECOUNT ) // 이펙트 제거 처리
		return TRUE;
