...
#include "NkMob.h"
#include "FX_BossRaid_Kai2_01.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CFxBossRaidKai2_01::CFxBossRaidKai2_01()
{
	m_pLolo = NULL;
}
...
void CFxBossRaidKai2_01::LoadRes()
{
	PFILE *fpLolo = NULL;
	...
	if (!m_pLolo)
	{
		...
		m_pLolo->Read("data/effect/lolos/boss_K02_attack01_eff.LOL");
	}
...
void CFxBossRaidKai2_01::DeleteRes()
{}

BOOL CFxBossRaidKai2_01::Render(EffectSort &effect_sort)
{
	if( !GET_D3DDEVICE() )
		return TRUE;
	...
	if( effect_sort.nCurFrame >= FX_BOSSRAID_KAI2_01_FRAMECOUNT ) // 이펙트 제거 처리
		return TRUE;
