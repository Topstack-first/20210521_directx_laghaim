...
#include "NkMob.h"
#include "FX_BossRaid_Kai3_02.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CFxBossRaidKai3_02::CFxBossRaidKai3_02()
{
	m_pLolo = NULL;
}
...
void CFxBossRaidKai3_02::LoadRes()
{
	if (!m_pLolo)
	{
		m_pLolo = new CLolos;
		m_pLolo->SetIndexedTexture( g_pCapsyongTexture );
		m_pLolo->Read("data/effect/lolos/boss_k03_attack02_eff.LOL");
	}
...
void CFxBossRaidKai3_02::DeleteRes()
{}

BOOL CFxBossRaidKai3_02::Render(EffectSort &effect_sort)
{
	if( !GET_D3DDEVICE() )
		return TRUE;
	...
	if( effect_sort.nCurFrame >= FX_BOSSRAID_KAI3_02_FRAMECOUNT ) // 이펙트 제거 처리
		return TRUE;
